/**
 * useTerminalSize — singleton hook that tracks terminal dimensions.
 *
 * Ported from Kode-Agent/src/ui/hooks/useTerminalSize.ts
 * Uses a global singleton pattern so all components share one resize listener.
 */
